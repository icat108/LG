  ...
  <div class="landing-page">
        ...
        <div class="flex items-center pt-10 px-5 md:px-0">
          <div class="w-1/2">
            <h1 class="text-4xl text-white mb-5">
              Kami membantu <u class="hero-underline">startup</u> ke <br />
              mulai & <u class="hero-underline">pendanaan</u> <br />
              kebutuhan mereka yang sebenarnya
            </h1>
            <p class="text-white text-xl font-light mb-8">
              Mendanai ide terbaik untuk menjadi <br />
      ...
      <div class="flex justify-between items-center mb-10">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            Hanya 3 langkah untuk dieksekusi <br />
      ...
      <div class="flex justify-between items-center text-center">
        <div class="w-1/3">
          ...
          <div class="step-content">
            ...
            <p class="font-light">
              Sign Up akun dan mulai <br />proyek pendanaan
            </p>
          </div>
        </div>
        <div class="w-1/3">
    ...
    <section class="container mx-auto pt-24" id="projects">
      <div class="flex justify-between items-center">
        <div class="w-auto">
          <h2 class="text-3xl text-gray-900 mb-8">
            Proyek baru Anda bisa diurus <br />
          </h2>
        </div>
